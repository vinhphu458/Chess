...
- (NSMutableArray *)getValidLocations {
    ...
    [self addLocation:self.location incrementX:1 incrementY:0 overlapAlly:false];
    [self addLocation:self.location incrementX:-1 incrementY:0 overlapAlly:false];
    [self addLocation:self.location incrementX:0 incrementY:-1 overlapAlly:false];
    [self addLocation:self.location incrementX:0 incrementY:1 overlapAlly:false];
    return locations;
}
...
- (NSMutableArray *)getValidLocationsOverlapAlly {
    ...
    [self addLocation:self.location incrementX:1 incrementY:0 overlapAlly:true];
    [self addLocation:self.location incrementX:-1 incrementY:0 overlapAlly:true];
    [self addLocation:self.location incrementX:0 incrementY:-1 overlapAlly:true];
    [self addLocation:self.location incrementX:0 incrementY:1 overlapAlly:true];
    return locations;
}
